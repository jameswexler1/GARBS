...
dotfilesrepo="https://github.com/jameswexler1/your-repo-name.git"
progsfile="https://raw.githubusercontent.com/jameswexler1/GARBS/main/progsGARBS.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
https://www.youtube.com/feeds/videos.xml?channel_id=UC3g31jXrLf6AtIcjWDujeFw \"Caio o Alemao\"
https://www.youtube.com/feeds/videos.xml?channel_id=UCkK9UDm_ZNrq_rIXCz3xCGA \"The Lunduke Journal\"
https://www.youtube.com/feeds/videos.xml?channel_id=UCSuHzQ3GrHSzoBbwrIq3LLA \"Naomi Brockwell\"
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Gustav's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke" 10 60
...
maininstall() {
	...
	whiptail --title "GARBS Installation" --infobox "Installing \`$1\` ($n of $total). $1 $2" 9 70
	installpkg "$1"
}
...
gitmakeinstall() {
	...
	whiptail --title "GARBS Installation" \
